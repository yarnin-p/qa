...
$folder_admin = "manage_dealer_";
if ($url != "localhost") {
    $config['base_url'] = $http . '://' . $url . '/' . $folder_admin . '/';
} else {
    $config['base_url'] = '/';
}


$config['portal_key'] = '$P|@NETPort@L=2019';
...
$config['first_page_no'] = 1;
$config['item_per_page'] = 50;

$config['limit'] = array('100', '200', '250', '300', '1000');
