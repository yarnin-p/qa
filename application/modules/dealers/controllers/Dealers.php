...
class Dealers extends MY_Controller
{
    ...
    protected $modules = "dealers";
    private $model = "dealers_model";
...
//                $data['dealer_img_url'] = $image['imageName'];
//            } else {
//                $data['dealer_img_url'] = '';
//            }
            if($input['dealer_password'] != $input['dealer_cpassword']) {
                redirect_back();
            }

            $data['dealer_name'] = $input['dealer_name'];
            $data['dealer_tel'] = $input['dealer_tel'];
            $data['dealer_line'] = $input['dealer_line'];
            $data['dealer_email'] = $input['dealer_email'];
            $data['username'] = $input['dealer_username'];
            $data['password'] = md5($input['dealer_password']);
...
//            }
            ...
            if($data['dealer_password'] != $input['dealer_cpassword']) {
                redirect_back();
            }
            ...
            $this->main_model->update_data($id, $data);
