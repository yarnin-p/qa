                ...
                <div class="col-xl-12 col-lg-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">ตารางรายชื่อดีลเลอร์</h4>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-sm-12 col-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    <th><?php echo column_head('tb_dealer_fullname', $this, 'Y', 'dealer_name', $order['by'], $order['type']); ?></th>
                                                    <th><?php echo column_head('tb_dealer_tel', $this, 'Y', 'dealer_tel', $order['by'], $order['type']); ?></th>
                                                    <th><?php echo column_head('tb_dealer_email', $this, 'Y', 'dealer_email', $order['by'], $order['type']); ?></th>
                                                    <th><?php echo column_head('tb_dealer_line', $this, 'Y', 'dealer_line', $order['by'], $order['type']); ?></th>
                                                    <th><?php echo column_head('tb_dealer_username', $this, 'Y', 'username', $order['by'], $order['type']); ?></th>
...
//                                    }
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $value['dealer_tel']; ?></td>
                                                            <td><?php echo $value['dealer_email']; ?></td>
                                                            <td><?php echo $value['dealer_line']; ?></td>
                                                                ...
                                                                <div class="switch">
                                                                    <div class="onoffswitch">
                                                                        <input
                                                                                ...
                                                                                id="status_<?php echo $value['dealer_id']; ?>"
                                                                                value="<?php echo $value['is_enable'] == '1' ? '1' : '0'; ?>"
                                                                                onclick="change_status(this, '<?php echo $value['dealer_id']; ?>');">
                                                                        <label
                                                                                class="onoffswitch-label"
                                                                                for="status_<?php echo $value['dealer_id']; ?>">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                if ($this->permission->state['edit']) {
                                                                    ?>
                                                                    <a href="<?php echo $url_ajax . 'edit?id=' . $value['dealer_id']; ?>"
                                                                ...
                                                                if ($this->permission->state['delete'] && $value['id'] != '1') {
                                                                    ?>
                                                                    <a data-href="<?php echo $url_ajax . 'delete?id=' . $value['dealer_id']; ?>"
