                                    ...
                                    <div class="col-xl-12 col-lg-12 col-sm-12">
                                        <form method="post" id="form_data" class="form form-horizontal"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="dealer_password" class="col-sm-3 label-control" required>
                                                        <?php echo $this->lang->line('label_form_dealer_password'); ?>
                                                    </label>
                                                    <div class="col-md-9 mx-auto">
                                                        <div class="col-sm-9">
                                                            <input type="password"
                                                                   ...
                                                                   id="dealer_password"
                                                                   placeholder="<?php echo $this->lang->line('label_form_dealer_password'); ?>"
                                                                   class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="dealer_cpassword" class="col-sm-3 label-control" required>
                                                        <?php echo $this->lang->line('label_form_dealer_cpassword'); ?>
                                                    </label>
                                                    <div class="col-md-9 mx-auto">
                                                        <div class="col-sm-9">
                                                            <input type="password"
                                                                   name="dealer_cpassword"
                                                                   id="dealer_cpassword"
                                                                   placeholder="<?php echo $this->lang->line('label_form_dealer_cpassword'); ?>"
                                                                   class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
