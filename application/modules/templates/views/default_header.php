...
<head>
    ...
    <!-- BEGIN: Vendor CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>vendors/css/vendors.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>vendors/css/tables/datatable/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>vendors/css/forms/icheck/icheck.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>vendors/css/forms/icheck/custom.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>font-awesome/css/all.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>plugins/select2/css/select2.min.css">
    <!-- END: Vendor CSS-->

    <!-- BEGIN: Theme CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>css/bootstrap-extended.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>css/colors.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>css/components.css">
    <!-- END: Theme CSS-->

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>css/core/menu/menu-types/vertical-menu-modern.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>css/core/colors/palette-gradient.css">
    <link rel="stylesheet" type="text/css" href="<?php echo $assets; ?>css/pages/invoice.css">
    <!-- END: Page CSS-->
    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto"><a class="navbar-brand" href="index.html"><img class="brand-logo" alt="modern admin logo" src="<?php echo $assets; ?>images/logo/logo.png">
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-bell"></i><span class="badge badge-pill badge-danger badge-up badge-glow">5</span></a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="scrollable-container media-list w-100">
                                ...
                                <a href="<?php echo base_url().'approve_price'; ?>">
                                    <div class="media">
                                        <div class="media-left align-self-center"><i class="ft-plus-square icon-bg-circle bg-cyan mr-0"></i></div>
                                        <div class="media-body">
                                            <h6 class="media-heading">สินค้านำเข้าระบบ</h6>
                                            <?php $amountProApproved = count($result_noti_approved); ?>
                                            <p class="notification-text font-small-3 text-muted">
                                                คุณมีสินค้านำเข้าที่ต้องอนุมัติ <?php echo number_format($amountProApproved, 0); ?> รายการ
                                            </p>
                                            <small>
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon ft-mail"></i></a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            ...
                            <li class="scrollable-container media-list w-100"><a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="<?php echo $assets; ?>images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span></div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left"><span class="avatar avatar-sm avatar-busy rounded-circle"><img src="<?php echo $assets; ?>images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span></div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="<?php echo $assets; ?>images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span></div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left"><span class="avatar avatar-sm avatar-away rounded-circle"><img src="<?php echo $assets; ?>images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span></div>
                                        <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">John Doe</span><span class="avatar avatar-online"><img src="<?php echo $assets; ?>images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span></a>
...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <?php $this->permission->displayMenu(); ?>
        </ul>
    </div>
</div>
