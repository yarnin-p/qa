                    ...
                    <div class="breadcrumb-wrapper col-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a
                                        href="<?php echo base_url().'user_group'; ?>">หน้าหลัก</a></li>
                            <li class="breadcrumb-item active">แก้ไขกลุ่มผู้ใช้งานระบบ</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">ฟอร์มแก้ไขกลุ่มผู้ใช้งานระบบ</h4>
                                        ...
                                        <form method="post" id="form_data" class="form form-horizontal"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="group_name_tha" class="col-sm-3 label-control" required>
                                                        <?php echo $this->lang->line('group_name_th'); ?>
                                                    </label>
                                                    <div class="col-md-9 mx-auto">
                                                        <div class="col-sm-9">
                                                            <input type="text"
                                                                   name="group_name_tha"
                                                                   id="group_name_tha"
                                                                   value="<?php echo $result['group_name']?>"
                                                                   placeholder="<?php echo $this->lang->line('group_name_th'); ?>"
                                                                   class="form-control"
