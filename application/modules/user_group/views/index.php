                ...
                <div class="col-xl-12 col-lg-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">ตารางรายการกลุ่มผู้ใช้งานระบบ</h4>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-sm-12 col-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    <th><?php echo column_head('group_name_th', $this, 'Y', 'group_name_' . $language, $order['by'], $order['type']); ?></th>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <div class="switch">
                                                                    <div class="onoffswitch">
                                                                        <input
                                                                                ...
                                                                                id="status_<?php echo $value['group_id']; ?>"
                                                                                value="<?php echo $value['is_enable'] == '1' ? '1' : '0'; ?>"
                                                                                onclick="change_status(this, '<?php echo $value['group_id']; ?>');"
                                                                        >
                                                                        <label
                                                                                class="onoffswitch-label"
                                                                                for="status_<?php echo $value['group_id']; ?>">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                if ($this->permission->state['edit']) {
                                                                    ?>
                                                                    <a href="<?php echo $url_ajax . 'edit?group_id=' . $value['group_id']; ?>"
                                                                ...
                                                                if ($this->permission->state['delete'] && $value['id'] != '1') {
                                                                    ?>
                                                                    <a data-href="<?php echo $url_ajax . 'delete?group_id=' . $value['group_id']; ?>"
