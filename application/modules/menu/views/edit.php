                ...
                <div class="col-xl-12 col-lg-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">ฟอร์มแก้ไขข้อมูลเมนู</h4>
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <div class="col-sm-9">
                                                            <select class="form-control select2"
                                                                    ...
                                                                    id="parent_id">
                                                                <?php
                                                                if ($result['level_no'] == 0) {
                                                                    ?>
                                                                    <option value="-1" selected><?php echo $this->lang->line('label_select_parent_menu') ?></option>
                                                                    <?php
                                                                } ?>

                                                                <?php if($result['level_no'] == 1){ ?>
                                                                    <option value="-1"><?php echo $this->lang->line('label_select_parent_menu') ?></option>
                                                                <?php } ?>
                                                                <?php if (!empty($get_menu_level)) {
                                                                    foreach ($get_menu_level as $key => $value) { ?>
                                                                        <option
                                                                                value="<?php echo $value['parent_id'] ?>"
                                                                            <?php echo  ($value['parent_id'] == $result['parent_id'] && $result['level_no'] > 0) ? 'selected' : '';?>
                                                                        ><?php echo $value['text_name_tha'] ?></option>
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <div class="col-sm-9">
                                                            <input type="text"
                                                                   ...
                                                                   class="form-control"
                                                                   value="<?php echo $result['screen_id'] ?>"
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <div class="col-sm-9">
                                                            <input type="text"
                                                                   ...
                                                                   class="form-control"
                                                                   value="<?php echo $result['text_name_tha'] ?>"
                                                                   data-rule-required="true"
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <div class="col-sm-9">
                                                            <input type="text"
                                                                   ...
                                                                   class="form-control"
                                                                   value="<?php echo $result['text_name_eng'] ?>"
                                                                   data-rule-required="true"
