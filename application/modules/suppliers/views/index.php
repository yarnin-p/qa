                                    ...
                                    <div class="col-xl-12 col-lg-12 col-sm-12 col-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    <th><?php echo column_head('label_form_supplier_name', $this, 'Y', 'supplier_name', $order['by'], $order['type']); ?></th>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <div class="switch">
                                                                    <div class="onoffswitch">
                                                                        <input type="checkbox" <?php echo $value['is_enable'] == '1' ? 'checked' : ''; ?>
                                                                               ...
                                                                               id="status_<?php echo $value['supplier_id']; ?>"
                                                                               value="<?php echo $value['is_enable'] == '1' ? '1' : '0'; ?>"
                                                                               onclick="change_status(this, '<?php echo $value['supplier_id']; ?>');">
                                                                        <label
                                                                                class="onoffswitch-label"
                                                                                for="status_<?php echo $value['supplier_id']; ?>">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                if ($this->permission->state['edit']) {
                                                                    ?>
                                                                    <a href="<?php echo $url_ajax . 'edit?id=' . $value['supplier_id']; ?>"
                                                                ...
                                                                if ($this->permission->state['delete'] && $value['id'] != '1') {
                                                                    ?>
                                                                    <a data-href="<?php echo $url_ajax . 'delete?id=' . $value['supplier_id']; ?>"
